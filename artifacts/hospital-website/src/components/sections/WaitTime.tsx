            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-xl shadow-black/5 border border-slate-100 mb-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-gray-500 font-medium">Average Wait</span>
                    </div>
                  </div>
                </div>
                <div className="text-left sm:text-right">
                  <span className="block text-2xl font-bold text-gray-900 font-display">15 mins</span>
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm font-medium">
                  <span className="text-primary">Streamlined Process</span>
                  <span className="text-gray-500">Minimal Delays</span>
                </div>
